...
{
  public class UnapplyFreezeStatusVisualsSystem : ReactiveSystem<GameEntity>
  {
    public UnapplyFreezeStatusVisualsSystem(GameContext gameContext) : base(gameContext)
    {
    }
