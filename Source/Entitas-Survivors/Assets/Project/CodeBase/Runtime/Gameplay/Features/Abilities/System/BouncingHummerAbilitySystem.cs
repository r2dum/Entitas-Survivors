...
{
  public class BouncingHummerAbilitySystem : IExecuteSystem
  {
    ...
    public BouncingHummerAbilitySystem(GameContext gameContext, IGameplayStaticDataService staticDataService, IArmamentFactory armamentFactory)
    {
      ...
      _abilities = gameContext.GetGroup(GameMatcher
        .AllOf(
          GameMatcher.BouncingHummerAbility,
