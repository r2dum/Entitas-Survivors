...
{
  public class UnapplyPoisonStatusVisualsSystem : ReactiveSystem<GameEntity>
  {
    public UnapplyPoisonStatusVisualsSystem(GameContext gameContext) : base(gameContext)
    {
    }
