...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, int>(
            ...
            (e, c) => ((CodeBase.Runtime.Gameplay.Features.Statuses.ApplierStatusLink)c).Value));

        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, int>(
            EntityLink,
            game.GetGroup(GameMatcher.EntityLink),
            (e, c) => ((CodeBase.Runtime.Gameplay.Core.EntityLink)c).Value));

        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, int>(
            Id,
            game.GetGroup(GameMatcher.Id),
            (e, c) => ((CodeBase.Runtime.Gameplay.Core.Id)c).Value));

        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, CodeBase.Runtime.Gameplay.Features.Abilities.AbilityId>(
            ParentAbility,
            game.GetGroup(GameMatcher.ParentAbility),
            (e, c) => ((CodeBase.Runtime.Gameplay.Features.Abilities.ParentAbility)c).Value));
    }
}
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithParentAbility(this GameContext context, CodeBase.Runtime.Gameplay.Features.Abilities.AbilityId Value) {
        return ((Entitas.EntityIndex<GameEntity, CodeBase.Runtime.Gameplay.Features.Abilities.AbilityId>)context.GetEntityIndex(Contexts.ParentAbility)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
