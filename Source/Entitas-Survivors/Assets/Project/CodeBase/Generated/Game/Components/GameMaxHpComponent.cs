...
public partial class GameEntity {
    ...
    public CodeBase.Runtime.Gameplay.Features.Lifetime.MaxHp maxHp { get { return (CodeBase.Runtime.Gameplay.Features.Lifetime.MaxHp)GetComponent(GameComponentsLookup.MaxHp); } }
    ...
    public GameEntity AddMaxHp(float newValue) {
        ...
        var component = (CodeBase.Runtime.Gameplay.Features.Lifetime.MaxHp)CreateComponent(index, typeof(CodeBase.Runtime.Gameplay.Features.Lifetime.MaxHp));
