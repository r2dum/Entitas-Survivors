...
public partial class GameEntity {
    ...
    public CodeBase.Runtime.Gameplay.Features.Lifetime.CurrentHp currentHp { get { return (CodeBase.Runtime.Gameplay.Features.Lifetime.CurrentHp)GetComponent(GameComponentsLookup.CurrentHp); } }
    ...
    public GameEntity AddCurrentHp(float newValue) {
        ...
        var component = (CodeBase.Runtime.Gameplay.Features.Lifetime.CurrentHp)CreateComponent(index, typeof(CodeBase.Runtime.Gameplay.Features.Lifetime.CurrentHp));
