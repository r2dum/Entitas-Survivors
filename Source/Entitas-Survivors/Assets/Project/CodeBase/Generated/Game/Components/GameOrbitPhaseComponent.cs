...
public partial class GameEntity {
    ...
    public CodeBase.Runtime.Gameplay.Features.Movement.OrbitPhase orbitPhase { get { return (CodeBase.Runtime.Gameplay.Features.Movement.OrbitPhase)GetComponent(GameComponentsLookup.OrbitPhase); } }
    ...
    public GameEntity AddOrbitPhase(float newValue) {
        ...
        var component = (CodeBase.Runtime.Gameplay.Features.Movement.OrbitPhase)CreateComponent(index, typeof(CodeBase.Runtime.Gameplay.Features.Movement.OrbitPhase));
