...
public partial class GameEntity {
    ...
    public CodeBase.Runtime.Gameplay.Core.WorldPosition worldPosition { get { return (CodeBase.Runtime.Gameplay.Core.WorldPosition)GetComponent(GameComponentsLookup.WorldPosition); } }
    ...
    public GameEntity AddWorldPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (CodeBase.Runtime.Gameplay.Core.WorldPosition)CreateComponent(index, typeof(CodeBase.Runtime.Gameplay.Core.WorldPosition));
