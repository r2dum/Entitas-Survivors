...
public partial class GameEntity {
    ...
    public CodeBase.Runtime.Gameplay.Features.Armaments.TargetLimit targetLimit { get { return (CodeBase.Runtime.Gameplay.Features.Armaments.TargetLimit)GetComponent(GameComponentsLookup.TargetLimit); } }
    ...
    public GameEntity AddTargetLimit(int newValue) {
        ...
        var component = (CodeBase.Runtime.Gameplay.Features.Armaments.TargetLimit)CreateComponent(index, typeof(CodeBase.Runtime.Gameplay.Features.Armaments.TargetLimit));
