...
public partial class GameEntity {
    ...
    public CodeBase.Runtime.Gameplay.Core.TransformComponent transform { get { return (CodeBase.Runtime.Gameplay.Core.TransformComponent)GetComponent(GameComponentsLookup.Transform); } }
    ...
    public GameEntity AddTransform(UnityEngine.Transform newValue) {
        ...
        var component = (CodeBase.Runtime.Gameplay.Core.TransformComponent)CreateComponent(index, typeof(CodeBase.Runtime.Gameplay.Core.TransformComponent));
