...
public partial class GameEntity {
    ...
    public CodeBase.Runtime.Gameplay.Core.SpriteRendererComponent spriteRenderer { get { return (CodeBase.Runtime.Gameplay.Core.SpriteRendererComponent)GetComponent(GameComponentsLookup.SpriteRenderer); } }
    ...
    public GameEntity AddSpriteRenderer(UnityEngine.SpriteRenderer newValue) {
        ...
        var component = (CodeBase.Runtime.Gameplay.Core.SpriteRendererComponent)CreateComponent(index, typeof(CodeBase.Runtime.Gameplay.Core.SpriteRendererComponent));
