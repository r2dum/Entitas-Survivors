...
public partial class GameEntity {
    ...
    public CodeBase.Runtime.Gameplay.Core.Damage damage { get { return (CodeBase.Runtime.Gameplay.Core.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (CodeBase.Runtime.Gameplay.Core.Damage)CreateComponent(index, typeof(CodeBase.Runtime.Gameplay.Core.Damage));
